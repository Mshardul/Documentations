...
- [Insertion Sort](#insertion-sort)
  - [Complexities](#complexities-3)
  - [Python code](#python-code-3)
- [Selection Sort](#selection-sort)
  - [Complexities](#complexities-4)
  - [Python code](#python-code-4)
- [Merge Sort](#merge-sort)
  - [Complexities](#complexities-5)
  - [Python code](#python-code-5)
- [Quick Sort](#quick-sort)
  - [Complexities](#complexities-6)
  - [Python code](#python-code-6)
- [Example Use Cases](#example-use-cases)
  - [Finding a Pair That Sums to a Target (Sorted Array)](#finding-a-pair-that-sums-to-a-target-sorted-array)
  - [Reversing an Array In-Place](#reversing-an-array-in-place)
  - [Move Zeros to the End (Variation)](#move-zeros-to-the-end-variation)
  - [String Palindrome Check](#string-palindrome-check)
- [Special Considerations \& Edge Cases](#special-considerations--edge-cases)
- [Search in a Rotated Sorted Array](#search-in-a-rotated-sorted-array)
  - [Problem Statement](#problem-statement)
  - [Solution](#solution)
  - [Complexities](#complexities-7)
- [3-Sum](#3-sum)
  - [Problem Statement](#problem-statement-1)
  - [Solution](#solution-1)
  - [Complexities](#complexities-8)
- [K-th Smallest Element (Using Quickselect)](#k-th-smallest-element-using-quickselect)
  - [Problem Statement](#problem-statement-2)
  - [Solution](#solution-2)
  - [Complexities](#complexities-9)
...
- [Search in a Sorted 2D Matrix](#search-in-a-sorted-2d-matrix)
  ...
  - [Solution](#solution-4)
  - [Complexities](#complexities-11)
- [Find Peak Element](#find-peak-element)
  - [Problem Statement](#problem-statement-5)
  - [Solution](#solution-5)
  - [Complexities](#complexities-12)
