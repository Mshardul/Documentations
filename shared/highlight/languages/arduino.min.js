  ...
  (() => {
    ...
    return (r) => {
      const n = {
        ...
        i = ((r) => {
          const n = r.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
            i = "[a-zA-Z_]\\w*::",
            a =
          ...
          var g;
          const _ = [m, c, s, n, r.C_BLOCK_COMMENT_MODE, l, o],
            b = {
              variants: [
                { begin: /=/, end: /;/ },
                { begin: /\(/, end: /\)/ },
                ...
                { relevance: 0, match: /,/ },
                {
                  ...
                  contains: [
                    ...
                    s,
                    {
                      ...
                      keywords: p,
                      relevance: 0,
                      contains: ["self", n, r.C_BLOCK_COMMENT_MODE, o, l, s],
                    },
                  ],
                },
                s,
